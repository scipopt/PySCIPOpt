...
def solve_segment_time(n,c,t,segments):
    ...
    TimeConstr = model.addConstr(T <= max_time, "TimeConstr")
    model.update()
...
def solve_ideal(n,c,t,segments):
    ...
    model.addConstr(f1 == T - min_time, "obj1")
    model.addConstr(f2 == C - min_cost, "obj2")
