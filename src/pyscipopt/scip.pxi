...
cdef class Model:
    ...
    def createCons(self, cons, name='', initial=True, separate=True,
    ...
    def addCons(self, cons, name='', initial=True, separate=True,
        ...
        pycons_initial = self.createCons(cons, **kwargs)
    ...
    def addConsDisjunction(self, conss, name = '', initial = True, 
        ...
        for i, cons in enumerate(conss):
            pycons = self.createCons(cons, name=name, initial = initial,
                                            enforce=enforce, check=check,
