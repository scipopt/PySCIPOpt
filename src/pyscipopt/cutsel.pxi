...
cdef SCIP_RETCODE PyCutselCopy (SCIP* scip, SCIP_CUTSEL* cutsel):
  return SCIP_OKAY

cdef SCIP_RETCODE PyCutselFree (SCIP* scip, SCIP_CUTSEL* cutsel):
...
cdef SCIP_RETCODE PyCutselInit (SCIP* scip, SCIP_CUTSEL* cutsel):
  cdef SCIP_CUTSELDATA* cutseldata
  cutseldata = SCIPcutselGetData(cutsel)
  PyCutsel = <Cutsel>cutseldata
  PyCutsel.cutselinit()
...
cdef SCIP_RETCODE PyCutselExit (SCIP* scip, SCIP_CUTSEL* cutsel):
  cdef SCIP_CUTSELDATA* cutseldata
  cutseldata = SCIPcutselGetData(cutsel)
  PyCutsel = <Cutsel>cutseldata
  PyCutsel.cutselexit()
...
cdef SCIP_RETCODE PyCutselInitsol (SCIP* scip, SCIP_CUTSEL* cutsel):
  cdef SCIP_CUTSELDATA* cutseldata
  cutseldata = SCIPcutselGetData(cutsel)
  PyCutsel = <Cutsel>cutseldata
...
cdef SCIP_RETCODE PyCutselExitsol (SCIP* scip, SCIP_CUTSEL* cutsel):
  cdef SCIP_CUTSELDATA* cutseldata
  cutseldata = SCIPcutselGetData(cutsel)
  PyCutsel = <Cutsel>cutseldata
