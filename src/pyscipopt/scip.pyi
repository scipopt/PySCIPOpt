...
class Model:
    ...
    data: Incomplete
    def __init__(self, *args, **kwargs) -> None: ...
    def _createConsGenNonlinear(self, cons: Incomplete, **kwargs: Incomplete) -> Incomplete: ...
    def _createConsLinear(self, lincons: Incomplete, **kwargs: Incomplete) -> Incomplete: ...
    def _createConsNonlinear(self, cons: Incomplete, **kwargs: Incomplete) -> Incomplete: ...
    def _createConsQuadratic(self, quadcons: Incomplete, **kwargs: Incomplete) -> Incomplete: ...
    ...
    @staticmethod
    def from_ptr(self, capsule: Incomplete, take_ownership: Incomplete = ...) -> Incomplete: ...
