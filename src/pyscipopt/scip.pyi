...
from typing import Any, AnyStr, ClassVar, Literal, SupportsFloat, overload
...
class Expr(ExprLike):
    ...
    def __rpow__(self, other: float, /) -> ExpExpr: ...
...
class GenExpr(ExprLike):
    ...
    def __rpow__(self, other: float, mod: Incomplete = ..., /) -> ExpExpr: ...
...
class Model:
    ...
    def addCoefLogicor(self, logicor_cons: Constraint, var: Variable) -> None: ...
    def addCons(
        self,
        cons: Incomplete,
        name: str = "",
    ...
    def getDualfarkasLogicor(self, logicor_cons: Constraint) -> float: ...
    def getDualsolKnapsack(self, cons: Constraint) -> float: ...
    def getDualsolLinear(self, cons: Constraint) -> float: ...
    def getDualsolLogicor(self, logicor_cons: Constraint) -> float: ...
    ...
    def getNVarsLogicor(self, logicor_cons: Constraint) -> int: ...
    ...
    @overload
    def getSolVal(self, sol: Solution | None, expr: Expr | GenExpr) -> float: ...
    @overload
    ...
    @overload
    def getVal(self, expr: Expr | GenExpr) -> float: ...
    @overload
    ...
    def getVarsLogicor(self, logicor_cons: Constraint) -> list[Variable]: ...
