...
class Benders:
    ...
    def bendersgetvar(self, variable: Incomplete, probnumber: Incomplete) -> Incomplete: ...
    def bendersinit(self) -> Incomplete: ...
    def bendersinitpre(self) -> Incomplete: ...
    def bendersinitsol(self) -> Incomplete: ...
    def benderspostsolve(self, solution: Incomplete, enfotype: Incomplete, mergecandidates: Incomplete, npriomergecands: Incomplete, checkint: Incomplete, infeasible: Incomplete) -> Incomplete: ...
    def benderspresubsolve(self, solution: Incomplete, enfotype: Incomplete, checkint: Incomplete) -> Incomplete: ...
...
class Benderscut:
    ...
    name: Incomplete
    def __init__(self) -> None: ...
    def benderscutexec(self, solution: Incomplete, probnumber: Incomplete, enfotype: Incomplete) -> Incomplete: ...
...
class Conshdlr:
    ...
    def conscheck(self, constraints: Incomplete, solution: Incomplete, checkintegrality: Incomplete, checklprows: Incomplete, printreason: Incomplete, completely: Incomplete) -> Incomplete: ...
    ...
    def consenfolp(self, constraints: Incomplete, nusefulconss: Incomplete, solinfeasible: Incomplete) -> Incomplete: ...
    def consenfops(self, constraints: Incomplete, nusefulconss: Incomplete, solinfeasible: Incomplete, objinfeasible: Incomplete) -> Incomplete: ...
    def consenforelax(self, solution: Incomplete, constraints: Incomplete, nusefulconss: Incomplete, solinfeasible: Incomplete) -> Incomplete: ...
    def consexit(self, constraints: Incomplete) -> Incomplete: ...
    def consexitpre(self, constraints: Incomplete) -> Incomplete: ...
    def consexitsol(self, constraints: Incomplete, restart: Incomplete) -> Incomplete: ...
    ...
    def conslock(self, constraint: Incomplete, locktype: Incomplete, nlockspos: Incomplete, nlocksneg: Incomplete) -> Incomplete: ...
    def consparse(self) -> Incomplete: ...
    def conspresol(self, constraints: Incomplete, nrounds: Incomplete, presoltiming: Incomplete, nnewfixedvars: Incomplete, nnewaggrvars: Incomplete, nnewchgvartypes: Incomplete, nnewchgbds: Incomplete, nnewholes: Incomplete, nnewdelconss: Incomplete, nnewaddconss: Incomplete, nnewupgdconss: Incomplete, nnewchgcoefs: Incomplete, nnewchgsides: Incomplete, result_dict: Incomplete) -> Incomplete: ...
    def consprint(self, constraint: Incomplete) -> Incomplete: ...
    def consprop(self, constraints: Incomplete, nusefulconss: Incomplete, nmarkedconss: Incomplete, proptiming: Incomplete) -> Incomplete: ...
    def consresprop(self) -> Incomplete: ...
    def conssepalp(self, constraints: Incomplete, nusefulconss: Incomplete) -> Incomplete: ...
...
class ExprCons:
    ...
    _rhs: Incomplete
    expr: Incomplete
    def __init__(self, expr: Incomplete, lhs: Incomplete = ..., rhs: Incomplete = ...) -> None: ...
    def normalize(self) -> Incomplete: ...
...
class ExprLike:
    ...
    def __array_ufunc__(self, ufunc: Incomplete, method: Incomplete, *args: Incomplete, **kwargs: Incomplete) -> Incomplete: ...
...
class Heur:
    ...
    name: Incomplete
    def __init__(self) -> None: ...
    def heurexec(self, heurtiming: Incomplete, nodeinfeasible: Incomplete) -> Incomplete: ...
...
class LP:
    ...
    def addCol(self, entries: Incomplete, obj: Incomplete = ..., lb: Incomplete = ..., ub: Incomplete = ...) -> Incomplete: ...
    def addCols(self, entrieslist: Incomplete, objs: Incomplete = ..., lbs: Incomplete = ..., ubs: Incomplete = ...) -> Incomplete: ...
    def addRow(self, entries: Incomplete, lhs: Incomplete = ..., rhs: Incomplete = ...) -> Incomplete: ...
    def addRows(self, entrieslist: Incomplete, lhss: Incomplete = ..., rhss: Incomplete = ...) -> Incomplete: ...
    def chgBound(self, col: Incomplete, lb: Incomplete, ub: Incomplete) -> Incomplete: ...
    def chgCoef(self, row: Incomplete, col: Incomplete, newval: Incomplete) -> Incomplete: ...
    def chgObj(self, col: Incomplete, obj: Incomplete) -> Incomplete: ...
    def chgSide(self, row: Incomplete, lhs: Incomplete, rhs: Incomplete) -> Incomplete: ...
    ...
    def getBounds(self, firstcol: Incomplete = ..., lastcol: Incomplete = ...) -> Incomplete: ...
    ...
    def getSides(self, firstrow: Incomplete = ..., lastrow: Incomplete = ...) -> Incomplete: ...
...
class Model:
    ...
    data: Incomplete
    def __init__(self, problemName: Incomplete = ..., defaultPlugins: Incomplete = ..., sourceModel: Incomplete = ..., origcopy: Incomplete = ..., globalcopy: Incomplete = ..., enablepricing: Incomplete = ..., createscip: Incomplete = ..., threadsafe: Incomplete = ...) -> None: ...
    ...
    def activateBenders(self, benders: Incomplete, nsubproblems: Incomplete) -> Incomplete: ...
    def addBendersSubproblem(self, benders: Incomplete, subproblem: Incomplete) -> Incomplete: ...
    def addCoefKnapsack(self, cons: Incomplete, var: Incomplete, weight: Incomplete) -> Incomplete: ...
    def addCoefLinear(self, cons: Incomplete, var: Incomplete, value: Incomplete) -> Incomplete: ...
    def addCons(self, cons: Incomplete, name: Incomplete = ..., initial: Incomplete = ..., separate: Incomplete = ..., enforce: Incomplete = ..., check: Incomplete = ..., propagate: Incomplete = ..., local: Incomplete = ..., modifiable: Incomplete = ..., dynamic: Incomplete = ..., removable: Incomplete = ..., stickingatnode: Incomplete = ...) -> Incomplete: ...
    def addConsAnd(self, vars: Incomplete, resvar: Incomplete, name: Incomplete = ..., initial: Incomplete = ..., separate: Incomplete = ..., enforce: Incomplete = ..., check: Incomplete = ..., propagate: Incomplete = ..., local: Incomplete = ..., modifiable: Incomplete = ..., dynamic: Incomplete = ..., removable: Incomplete = ..., stickingatnode: Incomplete = ...) -> Incomplete: ...
    def addConsCardinality(self, consvars: Incomplete, cardval: Incomplete, indvars: Incomplete = ..., weights: Incomplete = ..., name: Incomplete = ..., initial: Incomplete = ..., separate: Incomplete = ..., enforce: Incomplete = ..., check: Incomplete = ..., propagate: Incomplete = ..., local: Incomplete = ..., dynamic: Incomplete = ..., removable: Incomplete = ..., stickingatnode: Incomplete = ...) -> Incomplete: ...
    def addConsCoeff(self, cons: Incomplete, var: Incomplete, coeff: Incomplete) -> Incomplete: ...
    def addConsCumulative(self, vars: Incomplete, durations: Incomplete, demands: Incomplete, capacity: Incomplete, name: Incomplete = ..., initial: Incomplete = ..., separate: Incomplete = ..., enforce: Incomplete = ..., check: Incomplete = ..., modifiable: Incomplete = ..., propagate: Incomplete = ..., local: Incomplete = ..., dynamic: Incomplete = ..., removable: Incomplete = ..., stickingatnode: Incomplete = ...) -> Incomplete: ...
    def addConsDisjunction(self, conss: Incomplete, name: Incomplete = ..., initial: Incomplete = ..., relaxcons: Incomplete = ..., enforce: Incomplete = ..., check: Incomplete = ..., local: Incomplete = ..., modifiable: Incomplete = ..., dynamic: Incomplete = ...) -> Incomplete: ...
    def addConsElemDisjunction(self, disj_cons: Incomplete, cons: Incomplete) -> Incomplete: ...
    def addConsIndicator(self, cons: Incomplete, binvar: Incomplete = ..., activeone: Incomplete = ..., name: Incomplete = ..., initial: Incomplete = ..., separate: Incomplete = ..., enforce: Incomplete = ..., check: Incomplete = ..., propagate: Incomplete = ..., local: Incomplete = ..., dynamic: Incomplete = ..., removable: Incomplete = ..., stickingatnode: Incomplete = ...) -> Incomplete: ...
    def addConsKnapsack(self, vars: Incomplete, weights: Incomplete, capacity: Incomplete, name: Incomplete = ..., initial: Incomplete = ..., separate: Incomplete = ..., enforce: Incomplete = ..., check: Incomplete = ..., modifiable: Incomplete = ..., propagate: Incomplete = ..., local: Incomplete = ..., dynamic: Incomplete = ..., removable: Incomplete = ..., stickingatnode: Incomplete = ...) -> Incomplete: ...
    def addConsLocal(self, cons: Incomplete, validnode: Incomplete = ..., name: Incomplete = ..., initial: Incomplete = ..., separate: Incomplete = ..., enforce: Incomplete = ..., check: Incomplete = ..., propagate: Incomplete = ..., local: Incomplete = ..., dynamic: Incomplete = ..., removable: Incomplete = ..., stickingatnode: Incomplete = ...) -> Incomplete: ...
    def addConsNode(self, node: Incomplete, cons: Incomplete, validnode: Incomplete = ..., name: Incomplete = ..., initial: Incomplete = ..., separate: Incomplete = ..., enforce: Incomplete = ..., check: Incomplete = ..., propagate: Incomplete = ..., local: Incomplete = ..., dynamic: Incomplete = ..., removable: Incomplete = ..., stickingatnode: Incomplete = ...) -> Incomplete: ...
    def addConsOr(self, vars: Incomplete, resvar: Incomplete, name: Incomplete = ..., initial: Incomplete = ..., separate: Incomplete = ..., enforce: Incomplete = ..., check: Incomplete = ..., propagate: Incomplete = ..., local: Incomplete = ..., modifiable: Incomplete = ..., dynamic: Incomplete = ..., removable: Incomplete = ..., stickingatnode: Incomplete = ...) -> Incomplete: ...
    def addConsSOS1(self, vars: Incomplete, weights: Incomplete = ..., name: Incomplete = ..., initial: Incomplete = ..., separate: Incomplete = ..., enforce: Incomplete = ..., check: Incomplete = ..., propagate: Incomplete = ..., local: Incomplete = ..., dynamic: Incomplete = ..., removable: Incomplete = ..., stickingatnode: Incomplete = ...) -> Incomplete: ...
    ...
    def addMatrixConsDisjunction(self, conss: Incomplete, name: Incomplete = ..., initial: Incomplete = ..., relaxcons: Incomplete = ..., enforce: Incomplete = ..., check: Incomplete = ..., local: Incomplete = ..., modifiable: Incomplete = ..., dynamic: Incomplete = ...) -> Incomplete: ...
    ...
    def addVar(self, name: Incomplete = ..., vtype: Incomplete = ..., lb: Incomplete = ..., ub: Incomplete = ..., obj: Incomplete = ..., pricedVar: Incomplete = ..., pricedVarScore: Incomplete = ..., deletable: Incomplete = ...) -> Incomplete: ...
    def addVarLocks(self, var: Incomplete, nlocksdown: Incomplete, nlocksup: Incomplete) -> Incomplete: ...
    ...
    def adjustedVarLb(self, var: Incomplete, lb: Incomplete) -> Incomplete: ...
    def adjustedVarUb(self, var: Incomplete, ub: Incomplete) -> Incomplete: ...
    def aggregateVars(self, varx: Incomplete, vary: Incomplete, coefx: Incomplete = ..., coefy: Incomplete = ..., rhs: Incomplete = ...) -> Incomplete: ...
    ...
    def attachEventHandlerCallback(self, callback: Incomplete, events: Incomplete, name: Incomplete = ..., description: Incomplete = ...) -> Incomplete: ...
    ...
    def catchRowEvent(self, row: Incomplete, eventtype: Incomplete, eventhdlr: Incomplete) -> Incomplete: ...
    def catchVarEvent(self, var: Incomplete, eventtype: Incomplete, eventhdlr: Incomplete) -> Incomplete: ...
    def checkBendersSubproblemOptimality(self, solution: Incomplete, probnumber: Incomplete, benders: Incomplete = ...) -> Incomplete: ...
    def checkQuadraticNonlinear(self, cons: Incomplete) -> Incomplete: ...
    def checkSol(self, solution: Incomplete, printreason: Incomplete = ..., completely: Incomplete = ..., checkbounds: Incomplete = ..., checkintegrality: Incomplete = ..., checklprows: Incomplete = ..., original: Incomplete = ...) -> Incomplete: ...
    def chgCapacityKnapsack(self, cons: Incomplete, capacity: Incomplete) -> Incomplete: ...
    def chgCoefLinear(self, cons: Incomplete, var: Incomplete, value: Incomplete) -> Incomplete: ...
    def chgLhs(self, cons: Incomplete, lhs: Incomplete) -> Incomplete: ...
    def chgReoptObjective(self, coeffs: Incomplete, sense: Incomplete = ...) -> Incomplete: ...
    ...
    def chgVarBranchPriority(self, var: Incomplete, priority: Incomplete) -> Incomplete: ...
    ...
    def chgVarLbNode(self, node: Incomplete, var: Incomplete, lb: Incomplete) -> Incomplete: ...
    ...
    def chgVarUbNode(self, node: Incomplete, var: Incomplete, ub: Incomplete) -> Incomplete: ...
    ...
    def copyLargeNeighborhoodSearch(self, to_fix: Incomplete, fix_vals: Incomplete) -> Incomplete: ...
    def count(self) -> Incomplete: ...
    def createChild(self, nodeselprio: Incomplete, estimate: Incomplete) -> Incomplete: ...
    def createCons(self, conshdlr: Incomplete, name: Incomplete, initial: Incomplete = ..., separate: Incomplete = ..., enforce: Incomplete = ..., check: Incomplete = ..., propagate: Incomplete = ..., local: Incomplete = ..., modifiable: Incomplete = ..., dynamic: Incomplete = ..., removable: Incomplete = ..., stickingatnode: Incomplete = ...) -> Incomplete: ...
    def createConsFromExpr(self, cons: Incomplete, name: Incomplete = ..., initial: Incomplete = ..., separate: Incomplete = ..., enforce: Incomplete = ..., check: Incomplete = ..., propagate: Incomplete = ..., local: Incomplete = ..., modifiable: Incomplete = ..., dynamic: Incomplete = ..., removable: Incomplete = ..., stickingatnode: Incomplete = ...) -> Incomplete: ...
    def createEmptyRowSepa(self, sepa: Incomplete, name: Incomplete = ..., lhs: Incomplete = ..., rhs: Incomplete = ..., local: Incomplete = ..., modifiable: Incomplete = ..., removable: Incomplete = ...) -> Incomplete: ...
    def createEmptyRowUnspec(self, name: Incomplete = ..., lhs: Incomplete = ..., rhs: Incomplete = ..., local: Incomplete = ..., modifiable: Incomplete = ..., removable: Incomplete = ...) -> Incomplete: ...
    ...
    def createSol(self, heur: Incomplete = ..., initlp: Incomplete = ...) -> Incomplete: ...
    ...
    def dropRowEvent(self, row: Incomplete, eventtype: Incomplete, eventhdlr: Incomplete) -> Incomplete: ...
    def dropVarEvent(self, var: Incomplete, eventtype: Incomplete, eventhdlr: Incomplete) -> Incomplete: ...
    ...
    def getBendersAuxiliaryVar(self, probnumber: Incomplete, benders: Incomplete = ...) -> Incomplete: ...
    def getBendersSubproblem(self, probnumber: Incomplete, benders: Incomplete = ...) -> Incomplete: ...
    def getBendersVar(self, var: Incomplete, benders: Incomplete = ..., probnumber: Incomplete = ...) -> Incomplete: ...
    ...
    def getBipartiteGraphRepresentation(self, prev_col_features: Incomplete = ..., prev_edge_features: Incomplete = ..., prev_row_features: Incomplete = ..., static_only: Incomplete = ..., suppress_warnings: Incomplete = ...) -> Incomplete: ...
    def getBranchScoreMultiple(self, var: Incomplete, gains: Incomplete) -> Incomplete: ...
    ...
    def getDualSolVal(self, cons: Incomplete, boundconstraint: Incomplete = ...) -> Incomplete: ...
    ...
    def getMemExternEstim(self) -> Incomplete: ...
    def getMemTotal(self) -> Incomplete: ...
    def getMemUsed(self) -> Incomplete: ...
    ...
    def getNlRowSolActivity(self, nlrow: Incomplete, sol: Incomplete = ...) -> Incomplete: ...
    def getNlRowSolFeasibility(self, nlrow: Incomplete, sol: Incomplete = ...) -> Incomplete: ...
    ...
    def getRowParallelism(self, row1: Incomplete, row2: Incomplete, orthofunc: Incomplete = ...) -> Incomplete: ...
    def getSiblings(self) -> Incomplete: ...
    def getSlack(self, cons: Incomplete, sol: Incomplete = ..., side: Incomplete = ...) -> Incomplete: ...
    def getSlackVarIndicator(self, cons: Incomplete) -> Incomplete: ...
    def getSolObjVal(self, sol: Incomplete, original: Incomplete = ...) -> Incomplete: ...
    ...
    def getVarPseudocost(self, var: Incomplete, branchdir: Incomplete) -> Incomplete: ...
    def getVarPseudocostScore(self, var: Incomplete, solVal: Incomplete) -> Incomplete: ...
    def getVarRedcost(self, var: Incomplete) -> Incomplete: ...
    def getVarStrongbranch(self, var: Incomplete, itlim: Incomplete, idempotent: Incomplete = ..., integral: Incomplete = ...) -> Incomplete: ...
    ...
    def includeBenders(self, benders: Incomplete, name: Incomplete, desc: Incomplete, priority: Incomplete = ..., cutlp: Incomplete = ..., cutpseudo: Incomplete = ..., cutrelax: Incomplete = ..., shareaux: Incomplete = ...) -> Incomplete: ...
    def includeBendersDefaultCuts(self, benders: Incomplete) -> Incomplete: ...
    def includeBenderscut(self, benders: Incomplete, benderscut: Incomplete, name: Incomplete, desc: Incomplete, priority: Incomplete = ..., islpcut: Incomplete = ...) -> Incomplete: ...
    def includeBranchrule(self, branchrule: Incomplete, name: Incomplete, desc: Incomplete, priority: Incomplete, maxdepth: Incomplete, maxbounddist: Incomplete) -> Incomplete: ...
    def includeConshdlr(self, conshdlr: Incomplete, name: Incomplete, desc: Incomplete, sepapriority: Incomplete = ..., enfopriority: Incomplete = ..., chckpriority: Incomplete = ..., sepafreq: Incomplete = ..., propfreq: Incomplete = ..., eagerfreq: Incomplete = ..., maxprerounds: Incomplete = ..., delaysepa: Incomplete = ..., delayprop: Incomplete = ..., needscons: Incomplete = ..., proptiming: Incomplete = ..., presoltiming: Incomplete = ...) -> Incomplete: ...
    def includeCutsel(self, cutsel: Incomplete, name: Incomplete, desc: Incomplete, priority: Incomplete) -> Incomplete: ...
    def includeDefaultPlugins(self) -> Incomplete: ...
    def includeEventhdlr(self, eventhdlr: Incomplete, name: Incomplete, desc: Incomplete) -> Incomplete: ...
    def includeHeur(self, heur: Incomplete, name: Incomplete, desc: Incomplete, dispchar: Incomplete, priority: Incomplete = ..., freq: Incomplete = ..., freqofs: Incomplete = ..., maxdepth: Incomplete = ..., timingmask: Incomplete = ..., usessubscip: Incomplete = ...) -> Incomplete: ...
    def includeIISfinder(self, iisfinder: Incomplete, name: Incomplete, desc: Incomplete, priority: Incomplete = ..., freq: Incomplete = ...) -> Incomplete: ...
    def includeNodesel(self, nodesel: Incomplete, name: Incomplete, desc: Incomplete, stdpriority: Incomplete, memsavepriority: Incomplete) -> Incomplete: ...
    def includePresol(self, presol: Incomplete, name: Incomplete, desc: Incomplete, priority: Incomplete, maxrounds: Incomplete, timing: Incomplete = ...) -> Incomplete: ...
    def includePricer(self, pricer: Incomplete, name: Incomplete, desc: Incomplete, priority: Incomplete = ..., delay: Incomplete = ...) -> Incomplete: ...
    def includeProp(self, prop: Incomplete, name: Incomplete, desc: Incomplete, presolpriority: Incomplete, presolmaxrounds: Incomplete, proptiming: Incomplete, presoltiming: Incomplete = ..., priority: Incomplete = ..., freq: Incomplete = ..., delay: Incomplete = ...) -> Incomplete: ...
    def includeReader(self, reader: Incomplete, name: Incomplete, desc: Incomplete, ext: Incomplete) -> Incomplete: ...
    def includeRelax(self, relax: Incomplete, name: Incomplete, desc: Incomplete, priority: Incomplete = ..., freq: Incomplete = ...) -> Incomplete: ...
    def includeSepa(self, sepa: Incomplete, name: Incomplete, desc: Incomplete, priority: Incomplete = ..., freq: Incomplete = ..., maxbounddist: Incomplete = ..., usessubscip: Incomplete = ..., delay: Incomplete = ...) -> Incomplete: ...
    def infinity(self) -> Incomplete: ...
    ...
    def isIntegral(self, value: Incomplete) -> Incomplete: ...
    ...
    def isReoptEnabled(self) -> Incomplete: ...
    ...
    def printProblem(self, ext: Incomplete = ..., trans: Incomplete = ..., genericnames: Incomplete = ...) -> Incomplete: ...
    def printRow(self, row: Incomplete) -> Incomplete: ...
    def printSol(self, solution: Incomplete = ..., write_zeros: Incomplete = ...) -> Incomplete: ...
    ...
    def readProblem(self, filename: Incomplete, extension: Incomplete = ...) -> Incomplete: ...
    ...
    def separateSol(self, sol: Incomplete = ..., pretendroot: Incomplete = ..., allowlocal: Incomplete = ..., onlydelayed: Incomplete = ...) -> Incomplete: ...
    def setBendersSubproblemIsConvex(self, benders: Incomplete, probnumber: Incomplete, isconvex: Incomplete = ...) -> Incomplete: ...
    ...
    def setEmphasis(self, paraemphasis: Incomplete, quiet: Incomplete = ...) -> Incomplete: ...
    def setEnforced(self, cons: Incomplete, newEnf: Incomplete) -> Incomplete: ...
    def setHeurTiming(self, heurname: Incomplete, heurtiming: Incomplete) -> Incomplete: ...
    ...
    def setObjective(self, expr: Incomplete, sense: Incomplete = ..., clear: Incomplete = ...) -> Incomplete: ...
    ...
    def setSolVal(self, solution: Incomplete, var: Incomplete, val: Incomplete) -> Incomplete: ...
    def setStringParam(self, name: Incomplete, value: Incomplete) -> Incomplete: ...
    def setupBendersSubproblem(self, probnumber: Incomplete, benders: Incomplete = ..., solution: Incomplete = ..., checktype: Incomplete = ...) -> Incomplete: ...
    def solveBendersSubproblem(self, probnumber: Incomplete, solvecip: Incomplete, benders: Incomplete = ..., solution: Incomplete = ...) -> Incomplete: ...
    ...
    def solveProbingLPWithPricing(self, pretendroot: Incomplete = ..., displayinfo: Incomplete = ..., maxpricerounds: Incomplete = ...) -> Incomplete: ...
    ...
    def tightenVarLb(self, var: Incomplete, lb: Incomplete, force: Incomplete = ...) -> Incomplete: ...
    def tightenVarLbGlobal(self, var: Incomplete, lb: Incomplete, force: Incomplete = ...) -> Incomplete: ...
    def tightenVarUb(self, var: Incomplete, ub: Incomplete, force: Incomplete = ...) -> Incomplete: ...
    def tightenVarUbGlobal(self, var: Incomplete, ub: Incomplete, force: Incomplete = ...) -> Incomplete: ...
    def to_ptr(self, give_ownership: Incomplete) -> Incomplete: ...
    def translateSubSol(self, sub_model: Incomplete, sol: Incomplete, heur: Incomplete) -> Incomplete: ...
    def trySol(self, solution: Incomplete, printreason: Incomplete = ..., completely: Incomplete = ..., checkbounds: Incomplete = ..., checkintegrality: Incomplete = ..., checklprows: Incomplete = ..., free: Incomplete = ...) -> Incomplete: ...
    def updateBendersLowerbounds(self, lowerbounds: Incomplete, benders: Incomplete = ...) -> Incomplete: ...
    def updateNodeLowerbound(self, node: Incomplete, lb: Incomplete) -> Incomplete: ...
    def updateVarPseudocost(self, var: Incomplete, valdelta: Incomplete, objdelta: Incomplete, weight: Incomplete) -> Incomplete: ...
    def version(self) -> Incomplete: ...
    def writeBestSol(self, filename: Incomplete = ..., write_zeros: Incomplete = ...) -> Incomplete: ...
    def writeBestTransSol(self, filename: Incomplete = ..., write_zeros: Incomplete = ...) -> Incomplete: ...
    def writeLP(self, filename: Incomplete = ...) -> Incomplete: ...
    def writeMIP(self, filename: Incomplete, genericnames: Incomplete = ..., origobj: Incomplete = ..., lazyconss: Incomplete = ...) -> Incomplete: ...
    def writeName(self, var: Incomplete) -> Incomplete: ...
    def writeParams(self, filename: Incomplete = ..., comments: Incomplete = ..., onlychanged: Incomplete = ..., verbose: Incomplete = ...) -> Incomplete: ...
    def writeProblem(self, filename: Incomplete = ..., trans: Incomplete = ..., genericnames: Incomplete = ..., verbose: Incomplete = ...) -> Incomplete: ...
    def writeSol(self, solution: Incomplete, filename: Incomplete = ..., write_zeros: Incomplete = ...) -> Incomplete: ...
    def writeStatistics(self, filename: Incomplete = ...) -> Incomplete: ...
    def writeStatisticsJson(self, filename: Incomplete = ...) -> Incomplete: ...
    def writeTransSol(self, solution: Incomplete, filename: Incomplete = ..., write_zeros: Incomplete = ...) -> Incomplete: ...
    def __del__(self) -> Incomplete: ...
    def __eq__(self, other: object, /) -> bool: ...
    def __ge__(self, other: object, /) -> bool: ...
    def __gt__(self, other: object, /) -> bool: ...
    def __hash__(self) -> int: ...
...
class Presol:
    model: Incomplete
    def __init__(self) -> None: ...
    def presolexec(self, nrounds: Incomplete, presoltiming: Incomplete) -> Incomplete: ...
